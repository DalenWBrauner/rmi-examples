...
public class Cat implements Animal {
    ...
    public <T> T fetch(T something) throws RemoteException {
        System.out.println("A cat ignores what is brought in front of it.");
    ...
    public void pet() throws RemoteException {
        System.out.println("A cat tolerates physical affection.");
        System.out.println(catNoise());
    }

    @Override
    public void eat(Food food) throws RemoteException {
        System.out.println("A cat eats some small amount of the "+food.whatKind()+" in front of it.");
    ...
    private void intoTheStomach(int nutrients) {
        stomach += nutrients;
        if (stomach >= 100) {
            System.out.println("A cat has overeaten, and procedes to vomit everywhere.");
            stomach = 0;
            System.out.println(catNoise());
        }
    }
